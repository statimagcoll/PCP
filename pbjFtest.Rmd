...
2022/12/12 Reviewers at JCGS asked what happens when there are known effects of heteroskedasticity.
Here, we generate heteroskedasticity across space and across subjects independently to assess the effect on the different resampling-based estimators.

Smallest variance is 5% of largest variance.
...
Plot the results
```{r, eval=FALSE, fig.width=2, fig.height=10}
