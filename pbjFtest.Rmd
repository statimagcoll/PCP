...
#simtime = system.time(test <- simFunc(simConfig$form, simConfig$formred, simConfig$mask, readRDS(file.path(simdirs$simdir[400], 'data.rds')), simConfig$nboot, simConfig$cfts.s))
```
